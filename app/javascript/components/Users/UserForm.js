...
const UserForm = ({addOrUpdate, formAction, slug, aUser}) => {
    ...
    return(<StyledForm acceptCharset="UTF-8" onSubmit={handleSubmit(onSubmit)}>
        <Row>
            ...
            <StyledInput name="username" ref={register} defaultValue={(aUser) ? aUser.username : ""} type="text"/>
        </Row>
        <Row>
            <StyledLabel>First name:</StyledLabel>
            <StyledInput name="first_name" ref={register} defaultValue={(aUser) ? aUser.first_name : ""} type="text"/>
        </Row>
        <Row>
            <StyledLabel>Last name:</StyledLabel>
            <StyledInput name="last_name" ref={register} defaultValue={(aUser) ? aUser.last_name : ""} type="text"/>
        </Row>
        <Row>
            <StyledLabel>Time zone:</StyledLabel>
            <select defaultValue={(aUser && aUser.time_zone) ? aUser.time_zone : null} name="time_zone" ref={register}>
                <option  value=""/>
        ...
        <Row>
            ...
            <StyledInput name="email" ref={register} defaultValue={(aUser) ? aUser.email : ""} type="text"/>
        </Row>
        <Row>
            <StyledLabel>Confirm Email:</StyledLabel>
            <StyledInput name="confirm_email" ref={register} defaultValue="" type="text"/>
        </Row>
        <Row>
            <StyledLabel>Change Password:</StyledLabel>
            <StyledInput name="change_password" ref={register} defaultValue="" type="text"/>
        </Row>
        <Row>
            <StyledLabel>Confirm Password:</StyledLabel>
            <StyledInput name="confirm_password" ref={register} defaultValue="" type="text"/>
        </Row>
        <Row>
            <StyledLabel>&nbsp;</StyledLabel>
            <SecondaryButton id="update_submit" name="commit" type="submit">{(aUser) ? "Update": "Create"}</SecondaryButton>&nbsp;&nbsp;
